...
test.describe('Global Navigation - Cross-Page Routing & Header (TDD)', () => {
  ...
  test('TC-NAV-001: should display Home hero banner and CTAs', async ({ homePage }) => {
  ...
  test('TC-NAV-002: should navigate to Contact page via "Get Started" hero CTA', async ({
    homePage,
  }) => {
  ...
  test('TC-NAV-003: should navigate to Blinds & Shades via "Learn More" hero CTA', async ({
    homePage,
  }) => {
  ...
  test('TC-NAV-004: should navigate to Services page via header nav menu', async ({
    headerNav,
    page,
  }) => {
    // ACT
  ...
  test('TC-NAV-005: should navigate to Free Estimate page via header nav menu', async ({
    headerNav,
    estimatePage,
    page,
  }) => {
